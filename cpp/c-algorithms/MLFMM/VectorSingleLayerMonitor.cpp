...
//constructors
VectorSingleLayerMonitor::VectorSingleLayerMonitor(){};


int VectorSingleLayerMonitor::get_output_space_dimension(){

    return output_space_dimension_;
}

void VectorSingleLayerMonitor::computeMoments(Eigen::MatrixXcd *moments,
                                                    const int L,
...
Eigen::MatrixXcd VectorSingleLayerMonitor::evaluateLocalExpansion(const Eigen::Vector3d &pos_eval,
...
Eigen::Vector3d VectorSingleLayerMonitor::evaluate_near_field_interaction(const Eigen::Vector3d &r,
